...
:::
::: {.alert .alert-danger role="alert"}
**Two dosing principles: liquid agents scale with soil mass, gas agents scale with headspace**
...
::: {.alert .alert-warning role="alert"}
**Expected day-0 reading is set by the real soil mass, not the calculation basis**
